...
public class Pila {
   ...
   //CANTIDAD EN LA LISTA
    ...
    //LA CIMA ES EL INCIIO DE LA LISTA
    //agregar un nodo a la cima ----PUSH
    public void push(Nodo nuevo){
        addBegin(nuevo); //AGREGAMOS EL NODO AL INICIO
    }
    //Lee el nodo ala cima de la pila
    public int peek(){
       return getAt(0); //Regresa el priemr nodo de la lista que es la posicion 0
    }
    //LEE Y QUITA EL NODO DE LA LISTA
